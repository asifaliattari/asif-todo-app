      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-900/50 backdrop-blur-lg rounded-2xl shadow-2xl border border-gray-800 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 disabled:from-gray-700 disabled:to-gray-700 text-white py-3 rounded-lg font-medium transition-all disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
        ...
        <div className="mt-6 bg-gray-900/30 border border-gray-800 rounded-lg p-4">
          <p className="text-sm text-gray-400 text-center">
            <span className="font-semibold text-gray-300">Demo:</span> Create an account to get started
          </p>
        </div>
      </div>
    </div>
